	...
	<nav class="navbar navbar-default top-menu">
        ...
        <?php $cur_post = get_the_ID();?>
			<ul class="nav nav-justified sections <?php echo(($cur_post==145)|($cur_post==148)|($cur_post==150) ? 'expanded':''); ?>">
				...
				<li class="gray-bg <?php echo ($cur_post==148 ? 'active':'notitle'); ?>"><a href="<?php echo get_permalink( 148 ) ?>"><i class="sprite-tender-search"></i> <span><?php echo get_the_title( 148 ) ?></span></a></li>
				<li class="blue-bg <?php echo ($cur_post==150 ? 'active':'notitle'); ?>"><a href="<?php echo get_permalink( 150 ) ?>"><i class="sprite-provider"></i> <span><?php echo get_the_title( 150 ) ?></span></a></li>
			</ul>
		</div>
