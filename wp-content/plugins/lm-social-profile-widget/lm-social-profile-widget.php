...
class Lm_Social_Share extends WP_Widget {
    ...
    public function widget($args, $instance) {
        ...
        // social profile link
        $facebook_profile = '<a data-type="fb" data-title="'.$datatitle.'" data-href="'.$datahref.'" href="" target="_blank"><i class="sprite-social-fb"></i></a>';
...
function linkenin_share_count($url) {
